...
(function () {
  ...
  const PROJECTS = [
    {
      name: "Ovronnaz",
      title: { en: "Appartement 2.5 pièces — Ovronnaz", fr: "Appartement 2.5 pièces — Ovronnaz" },
      desc: {
      ...
      pairs: [
        ...
        { label: { en: "Living Room — Furnished", fr: "Séjour — Meublé" },
          note: { en: "The apartment is now offered as a furnished alpine retreat — designed for both aesthetics and comfort, ready to welcome guests.", fr: "L'appartement est maintenant proposé en location meublée — conçu à la fois pour l'esthétique et le confort, prêt à accueillir des hôtes." },
          before: "images/ovronnaz/salon s16 before.jpg", after: "images/ovronnaz/s16 after.jpg" },
        { label: { en: "Kitchen", fr: "Cuisine" },
          note: { en: "The bar was imposing — dominating the kitchen and making an already dark space feel smaller. Its removal opened the room entirely, creating space for a proper dining table and a natural flow between kitchen and living area.", fr: "Le bar était très imposant — il dominait la cuisine et rendait l'espace sombre encore plus petit. Sa suppression a ouvert le volume, créant de la place pour une grande table et une fluidité naturelle entre cuisine et séjour." },
        ...
        { label: { en: "Corridor & Bathroom", fr: "Couloir & Salle de bain" },
          note: { en: "The corridor held significant lost space, and the original bathroom was too small. By pushing back the walls, we created a generous bathroom volume with dedicated built-in storage and a separate column for the washer-dryer.", fr: "Le couloir recélait un espace perdu important, et la salle de bain d'origine était trop petite. En repoussant les murs, nous avons créé un volume généreux avec des rangements dédiés et une colonne séparée pour la machine à laver." },
          before: "images/ovronnaz/s09 before.jpg", after: "images/ovronnaz/s09-after.jpg" },
        { label: { en: "Bathroom", fr: "Salle de bain" },
          note: { en: "The bathroom was reimagined with new tiling and fixtures. The window above the radiator was removed, clearing the space and adding a bespoke reclaimed-wood shelf in its place.", fr: "La salle de bain a été entièrement repensée. La fenêtre au-dessus du radiateur a été supprimée, dégageant l'espace et laissant place à une étagère en vieux bois sur mesure." },
        ...
        { label: { en: "Bathroom — Second View", fr: "Salle de bain — Deuxième vue" },
          note: { en: "A second angle of the bathroom transformation, showing the full scope of the renovation.", fr: "Un deuxième angle de la transformation de la salle de bain, montrant l'ampleur complète de la rénovation." },
          before: "images/ovronnaz/s11 before.jpg", after: ["images/ovronnaz/s11-after.jpg", "images/ovronnaz/s11- after.jpg"] },
        { label: { en: "Shower", fr: "Douche" },
          ...
          before: "images/ovronnaz/s12-before.jpg", after: "images/ovronnaz/s12after.jpg" },
